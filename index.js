...
client.on("messageCreate", async messageCreate => {
    if(messageCreate.content === "Okay, Penny is back online"){
...
client.on('messageCreate', messageCreate => {
    ...
    if(messageCreate.content === '!reassure') {
                rndmessage(messageCreate);
                ...
                function rndmessage(messageCreate) {
                    var messages = [ 
                            ...
                            "You do not have to change yourself to be enough, you already are.",
                            "You are worthy with or without someone reminding you, you always are and always will be.",
                            "You can and you will!",
                            "Always choose yourself.",
                            "To be human is to feel, let it all out.",
                            "You are always deserving of rest.",
                            "You are capable.",
                            "You are capable of positive change as you are of healing.",
                            "Your inner child would want to give you a hug right now!",
                            "You exist among billions upon billions of planets and galaxies that are perfectly created, do not ever think that you’re not destined to be here.",
                            "There is always room for improvement, let and help yourself grow.",
                            "You will manage as you always have.",
                            "Protect your mental health.",
                            "You don’t deserve the trauma and the pain that you’ve gone through.",
                            "Days will get heavy, but the sun doesn’t set and stay that way.",
                            "Your contributions are valuable.",
                            "It is not stupid if it makes you happy.",
                            "When you fail, you fail forward. It always leads to something beyond sight.",
                            "You deserve recovery.",
                            "Your past made you but it does not define you.",
                            "You are evolving.",
                            "It is enough to have done your best.",
                            "The “little” things you feel aren’t little.",
                            "You look beautiful when you talk about the things you love.",
                            "Your task is to do the best you can which is enough!",
                            ...
                            "Healing is possible.",
                            "Your negative thoughts do not define you.",
                            "The things you’ve accomplished, no matter how grand or little, deserve to be celebrated.",
                            "Your existence alone proves your strength.",
                            "Your mistakes and failures are learning experiences.",
                            "Failure is feedback, not a step back.",
                            ...
                            "It is okay to be scared and confused.",
                            "You can accept help from others, it does not make you weak.",
                            "You do not have to fit in to belong or to be important.",
                            "We are all works in progress.",
                            "You tried and you shall keep trying.",
                            "Release yourself from the weight of your regrets.",
                            "Like everyone, you have both strengths and weaknesses, not either.",
                            "You are beautifully unique.",
                            "Don’t worry, you are doing the best you can.",
                            "Your needs matter.",
                            "You are not less for making mistakes.",
                            "Productivity does not measure your worth.",
                            "One bad day does not make you a bad person. It makes you human.",
                            "No one else has the exact strengths that you have.",
                            "Listen to your body and what it tells you.",
                            "Others value your skill and knowledge.",
                            "You deserve unconditional love.",
                            "I would trust you with my secrets.",
                            "You can work through any setback!",
                            "You are allowed to come first in your life.",
                            "You have an immense amount of potential.",
